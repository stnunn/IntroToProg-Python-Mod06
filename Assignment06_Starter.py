...
# SNunn,5.22.2020,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #

# Data ---------------------------------------------------------------------- #
# Declare variables and constants
STR_FILE_NAME = "C:\\_PythonClass\\Assignment06\\ToDoFile.txt"  # The name of the data file
...
Processor.read_data_from_file(STR_FILE_NAME, lstTable)  # read file data
...
while (True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        ...
        if strChoice.lower() == "y":
            # TODO: Add Code Here! # Done
            Processor.write_data_to_file(STR_FILE_NAME, lstTable)
